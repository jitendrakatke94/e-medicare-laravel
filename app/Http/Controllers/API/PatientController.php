...
class PatientController extends Controller
{
    ...
    public function listFollowups(Request $request)
    {
        ...
        $list = Followups::where('patient_id', auth()->user()->id)->with('doctor:id,first_name,middle_name,last_name,profile_photo,consulting_online_fee,consulting_offline_fee,emergency_fee')->where('is_cancelled', 0)->where('is_completed', 0)->with('appointment')->whereHas('appointment', function ($query) {
